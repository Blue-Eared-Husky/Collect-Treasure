...
function draw(){
  ...
  drawSprites();
  fill("white");
  text("Score: " + treasureCollection,10,10);
}

function cash(){
  var cashx = Math.round(random(10,380));
...
function diamonds(){
  var diamondx = Math.round(random(10,380));
...
function jwellery(){
  var necklacex = Math.round(random(10,380));
...
function swords(){
  var swordx = Math.round(random(10,380));
